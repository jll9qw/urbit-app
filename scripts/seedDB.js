...
const herbSeed = [
  ...
  },
  {
    ...
    dosingFormat:
      "Cascara sagrada comes as oral tablets, capsules, and syrup. Follow the instructions on the package for the correct dose. Cascara is also prepared as a tea or aromaticfluid extract. The aromatic fluid extract dosage is 1 ml.",
    sideEffects:
  ...
  },
  {
    ...
    sideEffects:
      "In normal doses, ginger may cause heartburn and bloating. Women who are pregnant or breastfeeding should talk to their healthcare providers before taking any herbal medicines. There are no major food or medicine interactions linked with ginger. But some expertsthink it may change the effects of blood thinners (anticoagulants). Talk with yourhealthcare provider before taking ginger if you take blood thinner medicine."
  },
  {
    name: "Hawthorn",
  ...
  },
  {
    ...
    unsubstantiatedClaims:
      "There may be benefits that have not yet been proven through research. There are claims that alfalfa may help allergies thyroid problems, blood and livertoxicity, asthma, and how the pituitary works. It’s also said to reduce the risk ofheart attacks. It may also help with an inflamed prostate, rheumatoid arthritis stomach problems, and diabetes. There are reports that alfalfa works as a diuretic.",
  ...
  },
  {
    ...
    family: "Liliaceae",
    generalDescription:
      "Garlic consists of fresh or dried bulbs of the botanical plant Allium sativum. It’scultivated worldwide. The bulb or clove is the part of the plant that’s used most often. But sometimes garlic oil is used. Garlic is best stored hung in a dry place. Garlic contains alliin. When this is ground, it makes the strong-smelling potentantibacterial agent allicin. Garlic may have antibacterial effects. It’s also said to protect against atherosclerosis and stroke. This is because it keeps plateletsfrom sticking together. It may also lower high blood pressure and cholesterol.",
    medicallyValidUses:
    ...
    sideEffects:
      "Garlic has a strong taste and odor. Raw garlic can cause stomach upset in some people.Odorless garlic supplements get rid of the strong taste and odor. They may also reducestomach upset. Some people are allergic to garlic. When taken in large amounts, garlic may causeside effects. These include causing stomach ulcers and anemia. Garlic can interact with certain medicines. Using supplements of garlic that containallicin for a long time may decrease how well saquinavir (a medicine used to treatHIV) works. If you’re taking this medicine, talk with your healthcare provider beforeusing garlic. Be careful when taking blood thinner medicines because garlic may increase the risk of bleeding."
  },
  {
  ...
  },
  {
    ...
    sideEffects:
      "In August 2002, Canada banned the sale of kava products. This is due to its risk ofliver problems. The FDA says that people who have liver disease or liver problems should talk to their healthcare providers before taking kava. Talk to your healthcare provider if you take other medicines that affect the liver. Women who are pregnant or breastfeeding shouldn’t use kava. People with depression or bipolar disorder shouldn’t use kava. It may make your depression worse. If you use machinery or do other activities that need you to be alert, don’t use kava.It may make you drowsy. It may keep you from being able to drive a car safely. Kava may increase the effects of central nervous system medicines. These include depressants such as alcohol, barbiturates, and benzodiazepines. Taking alprazolam and kava together has caused comas."
  },
  {
    name: "Black Cohosh",
    ...
    dosingFormat:
      "Black cohosh comes in dried root, tablet, capsule and extract form. Follow the instructions on the package for the correct dos ",
    sideEffects:
  ...
  },
  {
    ...
    dosingFormat:
      "Feverfew is available in oral tablets, capsules, liquid extract and teas. Follow the instructions on the package for correct dos ",
    sideEffects:
      "Fresh leaves may cause mouth ulcers (aphthous ulcers) in some people. People withallergies, especially to ragweed, may be sensitive to it. This is because it’s a memberof the same plant family. Women who are pregnant or breastfeeding should not use feverfew. People who stop taking feverfew after using it for a long time may have withdrawal side effects. These include headaches trouble sleeping, anxiety, and stiff muscles. Do not take feverfew if:"
  },
  {
    name: "Ginkgo Biloba",
    ...
    sideEffects:
      "In rare cases, ginkgo biloba may cause side effects. These include upset stomach, headaches, and allergic skin reactions. Ginkgo biloba seeds can cause neurologic issuesand allergic reactions. These can cause death. For this reason, the seeds aren’t usedfor medical reasons. Talk to your healthcare provider before taking ginkgo if you take any other medicines.It may change the effects of other medicines, especially blood thinners (anticoagulants). Women who are pregnant or breastfeeding should talk to their healthcare providers before taking any herbal medicines."
  },
  {
    name: "Valerian",
    ...
    unsubstantiatedClaims:
      "There may be benefits that have not yet been proven through research. Valerian may act as a sedative. This calms the nervous system and reduces stress and nervousness. It may be used as a hypnotic. This induces a deep state of sleep. It may act as an anti-spasmodic. This means it reduces muscle spasms or cramps in themuscles. It may be used as a hypotensive agent. This lowers blood pressure. It’s usedas a carminative. This is an herbal remedy. It has a lot of volatile oils. It stimulates the digestive system to work well. Valerian may be used to reduce tension anxiety, stress, over-excitability, and hysterical feelings. It’s used to treat insomnia, menstrual pain, intestinal colic rheumaticpain, and migraine pain.",
    dosingFormat:
  ...
  },
  {
    ...
    generalDescription:
      'Aloe is a plant that likely came from Africa. More than 420 known species of aloe exist. The term "aloe vera" translates from Arabic and Hebrew to mean a "true shining, bitter substance." The succulent leaves are the part of the plant that’s most often used. The flower may also be used. Aloe vera has long been used in folk medicine. It’s known mostly for being able toaid in the healing process of cuts and burns. It’s also known to moisturize and softenthe skin. Aloe vera is also 1 of many anthelmintics. These are substances that destroyor get rid of worms from the digestive system. When swallowed, aloe acts as a laxative. When you scratch aloe leaves, they make abitter yellow liquid. It contains anthraquinone barbaloin. This is a strong laxative agent.',
    medicallyValidUses:
