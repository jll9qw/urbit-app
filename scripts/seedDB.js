...
const herbSeed = [
  { name: 'Glycine',
    ...
    'Side_effects toxicity and interactions':
  ...
  { name: null },
  { name: 'Cayenne',
    botanicalNames: 'Capsicum annuum, C. frutescens. Family: Solanaceae ',
    otherNames:
  ...
  { name: 'Saw Palmetto ',
    ...
    Common_names: 'Saw palmetto, shrub palmetto, dwarf palm ',
    generalDescription:
  ...
  { name: 'Black Cohosh ',
    ...
    dosingFormat:
     'Black cohosh comes in dried root, tablet, capsule and extract form. Follow the instructionson the package for the correct dose. ',
    'Side_effects toxicity and interactions':
  ...
  { name: 'Feverfew ',
    ...
    otherNames: "altamisa, bachelor's buttons, featherfew, featherfoil ",
    generalDescription:
    ...
    dosingFormat:
     'Feverfew is available in oral tablets, capsules, liquid extract and teas. Follow theinstructions on the package for correct dose. ',
    'Side_effects toxicity and interactions':
